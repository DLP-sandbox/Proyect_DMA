...
class FundamentalsAgent(BaseAgent):
    ...
    def _build_message(self, ticker, info, financials, ratios, earnings) -> str:
        ...
        lines = [
            ...
            "Los valores marcados con **[YF]** vienen DIRECTAMENTE de la fuente oficial de datos de mercado.",
            "Cuando menciones cualquier métrica en tu análisis, usa LITERALMENTE los valores [YF].",
            "NUNCA menciones la fuente de datos ni plataformas externas (Yahoo, TradingView, etc.) en tu texto.",
            ...
            f"- **Debt/Equity [YF]:** {num(info.get('debt_equity_yf'))} (tal cual lo reporta la fuente oficial)",
